...
namespace Hypothese2
{
    class Chat:Felin
    {
        public Chat(int pNombrePattes, string pNom, string pLieuHabitation, string pMonCrie, bool pJeSuisDomestique) : base(pNombrePattes, pNom, pLieuHabitation, pMonCrie, pJeSuisDomestique)
        {
